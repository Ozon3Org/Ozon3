# File Structure
This document is a reference primer on Ozone3's files: what, where, and for what.
...
This is the directory where main Ozone3 source code lives.

### media/

This subdirectory contains media related to Ozone3's documentation (README). Included here are demo GIFs and Ozone3 logo.

### ozone3/

This module is where core Ozone3 code lives.

#### ozone3.py

Main module that contains Ozone3's class definition.
...
This file contains most of code required to run the JavaScript functions and convert the result back into Python format that can be used by the rest of Ozone3.
...
These are test files. One test file is responsible for testing one of Ozone3's public method.
...
A custom shell script to automatically increment version. This is purely a convenience script so that each time Ozone3 needs a new release, we won't need to alter the version numbers in multiple places by hand.

## .github/

This folder is related to GitHub repository and not necessarily part of Ozone3 package.

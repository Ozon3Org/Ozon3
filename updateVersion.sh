...
sed -i "s/^    download_url=\"https:\/\/github.com\/Milind220\/Ozon3\/archive\/refs\/tags\/v${VERSION}.tar.gz\",/    download_url=\"https:\/\/github.com\/Milind220\/Ozon3\/archive\/refs\/tags\/v${UPDATED_VERSION}.tar.gz\",/" setup.py

"""Ozone3 module for the Ozone3 package.

This module contains the main Ozone3 class, which is used for all live-data
collection done by the Ozone3 package.

This module should be used only as a part of the Ozone3 package, and should not
be run directly.
    ...
    def get_historical_data(
        ...
        if city_id is None:
            ...
            warnings.warn(
                ...
                "Ozone3 will return air quality data from that station. "
